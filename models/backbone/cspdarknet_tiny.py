...
def cspdarknet_tiny(pretrained=False,in_channel=3, **kwargs):
    """Constructs a CSPDarknet53 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = CSPDarknetTiny(in_channel=in_channel)
    if pretrained:
        try:
            ...
            print('The pretrained weight of cspdarknet_tiny can not be found ...')
            pass
    else:
        print('Training the cspdarknet_tiny from scratch ...')
    return model
